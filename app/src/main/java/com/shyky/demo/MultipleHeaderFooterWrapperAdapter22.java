 ...
 * @since 1.0
 */
public class MultipleHeaderFooterWrapperAdapter22 extends WrapperAdapter {
    /**
    ...
    private final MultipleHeaderFooterRecyclerView.OnItemClickListener onItemClickListener;
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onItemClickListener != null) {
                        onItemClickListener.onItemClick(parent, v, getAdapterPosition(), -1);
                    }
                }
            });
        }
    ...
    public MultipleHeaderFooterWrapperAdapter22(Context context, RecyclerView.Adapter adapter) {
        this(context, null, null, adapter, null);
    }
    public MultipleHeaderFooterWrapperAdapter22(Context context, List<View> headerViews, List<View> footerViews, RecyclerView.Adapter adapter, MultipleHeaderFooterRecyclerView.OnItemClickListener onItemClickListener) {
