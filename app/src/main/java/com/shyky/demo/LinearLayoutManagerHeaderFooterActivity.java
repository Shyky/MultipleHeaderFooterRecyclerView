...
public class LinearLayoutManagerHeaderFooterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 这个方法同样也要在setAdapter方法之前调用，否则无效
        recyclerView.setOnItemClickListener(new MultipleHeaderFooterRecyclerView.OnItemClickListener() {
            @Override
