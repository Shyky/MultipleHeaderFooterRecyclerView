...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (adapter instanceof MultipleHeaderFooterWrapperAdapter22) {
            fromItemPosition = ((MultipleHeaderFooterWrapperAdapter22) adapter).getHeaderCount();
            toItemPosition = ((MultipleHeaderFooterWrapperAdapter22) adapter).getFooterCount();
        }
